...
const AddMicroEntrepreneur = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (files.length === 0) {
      Swal.fire("Ops", "Please select an image", "error");
      return;
    }
    ...
    formData.append("role", parseInt(3));
    ...
    try {
      ...
      Swal.fire("Success", "Micro Entrepreneurs Added Successfully", "success");
      setLoading(false);
      reset();
    } catch (error) {
  ...
  return (
    <div>
      <Card title="Add Micro Entrepreneurs">
...
export default AddMicroEntrepreneur;
