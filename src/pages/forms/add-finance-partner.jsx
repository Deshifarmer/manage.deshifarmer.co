...
const AddFinanceParter = () => {
  ...
  const onSubmit = async (data) => {
    ...
    formData.append("role", parseInt(5));
    ...
    try {
      ...
      Swal.fire("Success", "Finance Partner Added Successfully", "success");
      setLoading(false);
      reset();
    } catch (error) {
  ...
  return (
    <div>
      <Card title="Add Finance Partner">
...
export default AddFinanceParter;
