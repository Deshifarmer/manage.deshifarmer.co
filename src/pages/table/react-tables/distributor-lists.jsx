...
import { useGetSingleChannelDetailsQuery } from "../../../store/features/channels/api";

const DistributorList = ({ title = "Distributor Lists", params }) => {
  const {
    data: channel_details,
    isLoading,
    isError,
  } = useGetSingleChannelDetailsQuery(params.id);

  isError && console.log("Error in DistributorList");
  ...
  const data = useMemo(
    () => channel_details?.disrtibutor_list || [],
    [channel_details?.disrtibutor_list]
  );
