...
const COLUMNS = [
  ...
  },
  {
    ...
    Cell: (row) => {
      return (
        <div>
          <p className="text-xs">address : {row?.cell?.value}</p>
          <p className="text-xs">union : {row?.cell?.row?.original?.union}</p>
          <p className="text-xs">mouza : {row?.cell?.row?.original?.mouaza}</p>
        </div>
      );
    },
  },
