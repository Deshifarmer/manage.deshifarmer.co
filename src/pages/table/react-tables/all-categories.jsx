...
const COLUMNS = [
      ...
      return (
        <span>
          {row?.cell?.value === 1 ? (
            ...
            <div className="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-red-500 bg-red-500">
              Inactive
            </div>
          )}
        </span>
  ...
  //             <Link
  //               to={`/distributor/${row?.cell?.row?.original.deshifarmer_id}`}
  //             >
